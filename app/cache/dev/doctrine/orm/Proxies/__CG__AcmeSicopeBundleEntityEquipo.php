 ...
 */
class Equipo extends \Acme\SicopeBundle\Entity\Equipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\SicopeBundle\\Entity\\Equipo' . "\0" . 'idequipo', '' . "\0" . 'Acme\\SicopeBundle\\Entity\\Equipo' . "\0" . 'codigo', '' . "\0" . 'Acme\\SicopeBundle\\Entity\\Equipo' . "\0" . 'nombre', '' . "\0" . 'Acme\\SicopeBundle\\Entity\\Equipo' . "\0" . 'marca');
        }
